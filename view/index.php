            ...
            <div class="col-sm-3">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body"><img src="<?php echo $array[$i]->image ?>" class="img-responsive prod-img"
                        ...
                        <div class="ab" id="<?php echo 'u' . $array[$i]->id ?>"  onclick="<?php echo 'cartFunc(' . $array[$i]->id . ')' ?>"><span
        ...
        for ($i = 0; $i < count($array); $i++) {
            ...
            <div class="col-sm-3">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body"><img src="<?php echo $array[$i]->image ?>" class="img-responsive prod-img"
                                                 style="width:100%" alt="Image">
                        <div class="ab" id="<?php echo 'n' . $array[$i]->id ?>"  onclick="<?php echo 'cartFunc(' . $array[$i]->id . ')' ?>"><span
